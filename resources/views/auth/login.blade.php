        ...
        <div class="col-md-8 topatitraukimasnav">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Neteisingas E-Mail</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Neteisingas slaptažodis</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4 mygtukaspo">
                    ...
                    <div class="col-md-6 offset-md-4">
                        <button class="btn loginBtn loginBtn--facebook">
